<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse border border-right">
    <div class="position-sticky pt-3">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2 text-dark-emphasis{{ Request::is('dashboard/user*') ? 'active' : '' }}" aria-current="page" href="/dashboard/user">
                    <i class="bi bi-person-circle"></i>User</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2 text-dark-emphasis{{ Request::is('dashboard/contact*') ? 'active' : '' }}" aria-current="page" href="/dashboard/contact">
                    <i class="bi bi-person-lines-fill"></i>Contact</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2 text-dark-emphasis{{ Request::is('dashboard/address') ? 'active' : '' }}" aria-current="page" href="/dashboard/addresss">
